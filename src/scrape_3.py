...
driver.get("https://us.bremont.com/collections/altitude?pf_mlt_gender=gender%3Amens&pf_t_availability=availability-filter%3AReady+for+dispatch")
...
bremont_watch_df.to_csv('/home/ubuntu/Bremont/src/data/altitude.csv')
